...
# 1. Configuración de Flask y Variables
app = Flask(__name__)
...
if not TELEGRAM_BOT_TOKEN or not GEMINI_API_KEY:
    raise ValueError("ERROR: Faltan variables de entorno TELEGRAM_BOT_TOKEN o GEMINI_API_KEY.")
...
def telegram_webhook():
    if request.method == "POST":
        ...
        # Procesar actualización de forma sincrónica para Flask
